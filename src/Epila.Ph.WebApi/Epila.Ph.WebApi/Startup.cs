using Epila.Ph.WebApi.Infrastructure.Configs;
using Epila.Ph.WebApi.Infrastructure.Extensions;
...
namespace Epila.Ph.WebApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                c.RoutePrefix="doc";
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Epila.Ph.WebApi ASP.NET Core API v1");
            });
