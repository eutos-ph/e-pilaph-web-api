using Epila.Ph.Api.Infrastructure.Configs;
using Epila.Ph.Api.Infrastructure.Extensions;
...
namespace Epila.Ph.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Epila.Ph.Api ASP.NET Core API v1");
            });
